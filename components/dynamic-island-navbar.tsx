    ...
    <>
      <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50">
        <div className="glass rounded-full px-4 py-2 md:px-6 md:py-3 flex items-center gap-4 md:gap-8 bg-background/60 backdrop-blur-md border border-border/40 shadow-lg">
          ...
          <span
            className="text-lg md:text-xl font-bold text-black dark:text-white cursor-pointer"
            onClick={() => {
          ...
          {/* Desktop Navigation - STRIPPED & SIMPLIFIED */}
            ...
            {navLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  // PHASE 1 TEST: High contrast, standard colors. No variables.
      ...
      {isMobileMenuOpen && mounted && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-40 md:hidden w-[90%] max-w-[300px]">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className={`text-sm font-medium rounded-lg py-3 text-center transition-all ${
                    isActive 
